...
func (b *blah) ServeHTTP(w http.ResponseWriter, r *http.Request) {
    ...
    */
    ...
    fmt.Fprintf(w, "      document.write(\"<pre><code>My public IP address is: </code></pre>\", json.ip);\n")
    fmt.Fprintf(w, "    }\n")
    fmt.Fprintf(w, "  </script>\n")
    fmt.Fprintf(w, "  <script type=\"application/javascript\" src=\"https://api.ipify.org\"></script>")
